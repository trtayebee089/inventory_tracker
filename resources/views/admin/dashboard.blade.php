...
<div class="dashboard-main-body">
                ...
                <div
                    ...
                    <div class="col">
                        <div
                            class="card shadow-none border bg-gradient-start-1 h-100"
                        >
                            <div class="card-body p-20">
                                ...
                                >
                                    <div>
                                        <p
                                            class="fw-medium text-primary-light mb-1"
                                        >
                                            Total Users
                                        </p>
                    ...
                    <div class="col">
                        <div
                            class="card shadow-none border bg-gradient-start-2 h-100"
                        >
                            <div class="card-body p-20">
                                <div
                                    class="d-flex flex-wrap align-items-center justify-content-between gap-3"
                                ...
                                >
                                    <span
                                        class="d-inline-flex align-items-center gap-1 text-danger-main"
                                        ><iconify-icon
                                            icon="bxs:down-arrow"
                                            class="text-xs"
                                        ></iconify-icon>
                    ...
                    <div class="col">
                        <div
                            class="card shadow-none border bg-gradient-start-3 h-100"
                        >
                            <div class="card-body p-20">
                                <div
                                    class="d-flex flex-wrap align-items-center justify-content-between gap-3"
                    ...
                    <div class="col">
                        <div
                            class="card shadow-none border bg-gradient-start-4 h-100"
                        >
                            <div class="card-body p-20">
                                <div
                                    class="d-flex flex-wrap align-items-center justify-content-between gap-3"
                    ...
                    <div class="col">
                        <div
                            class="card shadow-none border bg-gradient-start-5 h-100"
                        >
                            <div class="card-body p-20">
                                <div
                                    class="d-flex flex-wrap align-items-center justify-content-between gap-3"
                ...
                <div class="row gy-4 mt-1">
                        ...
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                >
                                    ...
                                    <select
                                        class="form-select bg-base form-select-sm w-auto radius-8"
                                    >
                                ...
                                <div
                                    class="d-flex flex-wrap align-items-center gap-2 mt-8"
                                >
                                ...
                                <div
                                    id="chart"
                                    class="pt-28 apexcharts-tooltip-style-1"
                                ></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xxl-3 col-xl-6">
                        <div class="card h-100 radius-8 border">
                            <div class="card-body p-24">
                                ...
                                <div
                                    class="d-flex align-items-center gap-2 mb-20"
                                >
                    ...
                    <div class="col-xxl-3 col-xl-6">
                        <div
                            class="card h-100 radius-8 border-0 overflow-hidden"
                        >
                            <div class="card-body p-24">
                                <div
                                ...
                                >
                                    <li class="d-flex align-items-center gap-2">
                                        ...
                                        ></span>
                                        <span
                                            class="text-secondary-light text-sm fw-normal"
                                            >New:
                                            <span
                                                class="text-primary-light fw-semibold"
                                                >500</span
                                            >
                                        </span>
                                    </li>
                                    <li class="d-flex align-items-center gap-2">
                                        <span
                                            class="w-12-px h-12-px radius-2 bg-yellow"
                                        ></span>
                                        <span
                                            class="text-secondary-light text-sm fw-normal"
                                            >Subscribed:
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    >
                                        <div class="table-responsive scroll-sm">
                                            <table
                                                class="table bordered-table sm-table mb-0"
                                            >
                                                <thead>
                                                    <tr>
                                                        <th scope="col">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mt-32">
                                    ...
                                    >
                                        ...
                                        <span
                                            class="text-primary-light text-md fw-medium"
                                            >$20</span
                                        >
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row gy-4">
                                    <div class="col-lg-6">
                                        <div
                                            id="world-map"
                                            class="h-100 border radius-8"
                                        ></div>
                                    </div>

                                    <div class="col-lg-6">
                                        <div
                                            class="h-100 border p-16 pe-0 radius-8"
                                        >
                                            <div
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                class="text-xs text-secondary-light fw-medium"
                                                                >1,240
                                                                Users</span
                                                            >
                                                        </div>
                                                    ...
                                                    >
                                                        <div
                                                            class="w-100 max-w-66 ms-auto"
                                                        >
                                                            <div
                                                                class="progress progress-sm rounded-pill"
                                                                role="progressbar"
                                                            ...
                                                            >
                                                                <div
                                                                    class="progress-bar bg-primary-600 rounded-pill"
                                                                    style="
                                                                        width: 80%;
                                                                    "
                                                                ></div>
                                                        ...
                                                        <span
                                                            class="text-secondary-light font-xs fw-semibold"
                                                            >80%</span
                                                        >
                                                    </div>
                                                </div>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            ...
                                                            >
                                                                <div
                                                                    class="progress-bar bg-yellow rounded-pill"
                                                                    style="
                                                                        width: 49%;
                                                                    "
                                                                ></div>
                    ...
                    <div class="col-xxl-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <ul
                                    class="d-flex flex-wrap align-items-center mt-3 gap-3"
                                >
                                    <li class="d-flex align-items-center gap-2">
                                        <span
                                        ...
                                        <span
                                            ...
                                            >Word:
                                            <span
                                                class="text-primary-light fw-bold"
                                                >500</span
                                            >
                                        </span>
                                    </li>
